...
#     --plugin ClinVarAnnotation,ClinVar.vcf.gz --cache --dir_cache ~/.vep    #
#                                                                             #
# REQUIREMENTS:                                                               #
# - Ensembl VEP                                                               #
...
perl vep \
    ...
    --plugin ClinVarAnnotation,ClinVar.vcf.gz \
    --cache \
    --dir_cache ~/.vep
```
=cut

package ClinVarAnnotation;
...
sub new {
    ...
    # Initialize plugin-specific variables here
    return $self;
}
