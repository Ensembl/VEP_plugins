...
=head1 DESCRIPTION
  ...
  The PrimateAI VEP plugin is designed to retrieve clinical impact scores of variants, as described in https://www.nature.com/articles/s41588-018-0167-z. In brief, common missense mutations in non-human primate species are usually benign in humans. They can therefore be eliminated from screens for pathogenic mutations.
...
sub new {
  ...
  if ($file =~ /PrimateAI_scores_v0.2.tsv.bgz/){
  ...
  if ($file =~ /PrimateAI_scores_v0.2i_hg38.tsv.bgz/){
