...
=head1 DESCRIPTION
 ...
 Data files for GRCh37 are available from ftp://ftp.ensembl.org/pub/release-75/fasta/ancestral_alleles/
 Data files for GRCh38 are available from ftp://ftp.ensembl.org/pub/current_fasta/ancestral_alleles/
